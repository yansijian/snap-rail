...
import type { Dict } from '@snap-rail/cosmokit'
import { ModuleLoader, type ModuleJob, type ResolveResult } from '@snap-rail/cordis-plugin-loader'
import type { Include } from '@snap-rail/cordis-plugin-include'
import { FSWatcher, watch, type ChokidarOptions } from 'chokidar'
import { dirname, relative, resolve } from 'node:path'
import { realpath, stat } from 'node:fs/promises'
import { handleError } from './error.ts'
import type {} from '@snap-rail/cordis-plugin-timer'
import { fileURLToPath, pathToFileURL } from 'node:url'
import { createRequire } from 'node:module'
import picomatch from 'picomatch'
import z from '@snap-rail/schemastery'
