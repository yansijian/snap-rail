/**
 * The LLM endpoint configuration page: service address, key, and model for
 ...
 * store).
 *
 * @module @snap-rail/forge/client/config-page
 */
...
import { Button, Card, CardContent, Input, Label } from '@snap-rail/client-ui'
import { FORGE_LLM_KEY, llmConfigSchema } from '../contract.ts'

/** The configuration page. */
export function ForgeConfigPage(props: { ctx: Context }): ReactNode {
  ...
  return (
    <div className="space-y-4 p-4" data-forge="config">
      <Card>
